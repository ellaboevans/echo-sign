  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    try {
      ...
      if (typeof globalThis !== "undefined" && globalThis.window) {
        globalThis.window.localStorage.removeItem("sig_dir_current_user");
        globalThis.window.localStorage.removeItem("sig_dir_current_tenant");
      }
      ...
      const host = globalThis.location?.hostname || "lvh.me";
